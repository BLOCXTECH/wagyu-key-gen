...
export const errors = {
  ...
  DEPOSIT_AMOUNT: "Amount must be between 16384 and 100000.",
...
export const tooltips = {
  ...
  AMOUNT: "Enter the amount you would like to deposit for each validator. This value must be between 16384 and 100000 and can not have greater precision than 1 gwei. You must have withdrawal credentials defined and set \"compounding\".",
