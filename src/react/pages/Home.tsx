...
const Home = () => {
  ...
  const [wasNetworkModalOpened, setWasNetworkModalOpened] = useState(true);
  ...
  return (
    <div className="tw-flex tw-flex-col tw-pt-8">
      ...
      <div className="tw-flex tw-flex-col tw-items-center tw-mt-4">
        <Typography className="tw-text-4xl tw-mb-5" variant="h1"><b>Welcome to the BLOCX. Wagyu Key Generator</b></Typography>
        ...
        <div className="tw-mt-5">
          <div>
            ...
            <span className="tw-text-sm">https://github.com/blocxtech/wagyu-key-gen</span>
          </div>
        </div>
